...
public class House extends Facility{
    ...
    public House(String idFacility, String service, double areaUsing, double rentalFee, int numberOfPeople, String rentalType, String standardOfRoom, int numberOfFloor) {
